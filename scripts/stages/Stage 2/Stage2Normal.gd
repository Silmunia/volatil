...
func _ready():
	...
	flowControl = true
	residueCounter = 0
	get_node("HUD").SetPauseCurrentStage("res://scenes/stages/Stage 2/Stage2Normal.tscn")
...
func _on_MainCharacter_updateHealth(characterState, health):
	if (characterState == "Health"):
		GameMaster.SetStageEndInfo("2", stageType, residueCounter)
...
func _on_FlowTimer_timeout():
	...
	elif (stageState == 6 or stageState == 11 or stageState == 17 or stageState == 22 or stageState == 26 or stageState == 31 or stageState == 35 or stageState == 40 or stageState == 45):
		stageState -= 1
	elif (stageState == 46):
		stageState = 47
...
func StageStateMachine():
	match stageState:
		...
		13:
			get_node("HUD").get_node("CanvasLayer/Messages/Hint/TextureRect/Label").set_text("Agora que você tem o resíduo de NÍQUEL em mãos, é hora de começar o tratamento")
			TutorialFlowControl(1, 5, "Hint")
		...
		14:
			...
			TutorialCheckAdvance(1, "Balance", 18)
		15:
			get_node("HUD").get_node("CanvasLayer/Messages/Hint/TextureRect/Label").set_text("A primeira etapa do tratamento do resíduo de níquel é AJUSTAR O PH")
			TutorialFlowControl(1, 5, "Hint")
			TutorialCheckResidueError(0, null)
			TutorialCheckAdvance(1, "Balance", 18)
		16:
		...
		23:
			TutorialFlowControl(0, 1, null)
		24:
			get_node("HUD").get_node("CanvasLayer/Messages/Hint/TextureRect/Label").set_text("A segunda etapa para o resíduo de níquel é VERIFICAR a eficiência da reação")
			TutorialFlowControl(1, 5, "Hint")
			TutorialCheckResidueError(1, "Balance")
			TutorialCheckAdvance(1, "Checker", 27)
		25:
			TutorialFlowControl(0, 1, null)
			TutorialCheckResidueError(1, "Balance")
			TutorialCheckAdvance(1, "Checker", 27)
		...
		32:
			TutorialFlowControl(0, 1, null)
		33:
			get_node("HUD").get_node("CanvasLayer/Messages/Hint/TextureRect/Label").set_text("A terceira etapa do tratamento do resíduo de níquel é FILTRAR")
			TutorialFlowControl(1, 5, "Hint")
			TutorialCheckResidueError(1, "Checker")
		...
		43:
			...
			TutorialCheckAdvance(2, null, null)
		44:
			get_node("HUD").get_node("CanvasLayer/Messages/Hint/TextureRect/Label").set_text("Leve o resíduo de níquel até o equipamento indicado para ARMAZENAR adequadamente")
			if (flowControl):
